/*
December 22, 2014
Just-Dice.com Roll Calculator
https://github.com/ConorCulhane/Roll

Shout out to: BayAreaCoins, Nix, Otter, JAWSATEME, inkha, YNA
Keep Digging CLAM!
 */
package rangejdrollcalculator;
...
public class RangeJDRollCalculator {

   public static void main(String[] args) {
        Scanner input = new Scanner (System.in);
        System.out.println("Enter server seed:");
        String serverHash = input.next(); //takes entered server seed
        System.out.println("Enter Client Seed:");
        String clientSeed = input.next();
